function createNewCard() {
  ...
  var cardDownHTML = '<div class="card-down">Content for card-down</div>';
  var cardUpHTML = '<div class="card-up">Content for card-up</div>';
...
function shuffleCardImageClasses() {
  ...
  var cardClass = ["image-1", "image-1", "image-2", "image-2", "image-3", "image-3", "image-4", "image-4", "image-5", "image-5", "image-6", "image-6"];

  var shuffledCardClasses = _.shuffle(cardClass);
...
function createCards(parentElement, shuffledImageClasses) {
  ...
  for (i = 0; i < 12; i++) {
    var result = appendNewCard(parentElement);
...
function resetGame() {
  ...
  createCards(cardContainer, shuffleCardImageClasses());
